...
export type TodoPageQueryVariables = Types.Exact<{
...
/**
 * __useTodoPageQuery__
 *
 * To run a query within a React component, call `useTodoPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useTodoPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTodoPageQuery({
 *   variables: {
 *      categoryId: // value for 'categoryId'
 *   },
 * });
 */
export function useTodoPageQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<TodoPageQuery, TodoPageQueryVariables>) {
        return ApolloReactHooks.useQuery<TodoPageQuery, TodoPageQueryVariables>(TodoPageDocument, baseOptions);
      }
export function useTodoPageLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<TodoPageQuery, TodoPageQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<TodoPageQuery, TodoPageQueryVariables>(TodoPageDocument, baseOptions);
        }
export type TodoPageQueryHookResult = ReturnType<typeof useTodoPageQuery>;
export type TodoPageLazyQueryHookResult = ReturnType<typeof useTodoPageLazyQuery>;
export type TodoPageQueryResult = ApolloReactCommon.QueryResult<TodoPageQuery, TodoPageQueryVariables>;
export function refetchTodoPageQuery(variables?: TodoPageQueryVariables) {
      return { query: TodoPageDocument, variables: variables }
    }
